...
logging.basicConfig(filename=os.path.join(log_dir, "running_logs_or"), level=logging.INFO, format=logging_str)
...
if __name__ == "__main__": # << entry point
    ...
    try:
        logging.info("\n>>>>>>> Starting training <<<<<<<")
        main(data=OR, eta=ETA, epochs=EPOCHS, filename="or_new.model", plotfilename="or_new.png")
